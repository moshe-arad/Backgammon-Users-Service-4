...
@Component
public class FromMongoEventsStoreEventsConsumerNonJson extends SimpleBackgammonEventsConsumer<FromMongoEventsStoreEvent> {
	
	@Autowired
	private SnapshotAPI snapshotAPI;
	
	Logger logger = LoggerFactory.getLogger(FromMongoEventsStoreEventsConsumerNonJson.class);
	...
	public FromMongoEventsStoreEventsConsumerNonJson() {
	}
	
	public FromMongoEventsStoreEventsConsumerNonJson(SimpleConsumerConfig simpleConsumerConfig, String topic) {
