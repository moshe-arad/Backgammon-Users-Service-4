...
public class LoggedOutOpenByLeftBeforeGameStartedEventConsumer extends SimpleEventsConsumer {
	...
	public void consumerOperations(ConsumerRecord<String, String> record) {
		...
		try{			
			String loggedOutUserName = loggedOutOpenByLeftBeforeGameStartedEvent.getLoggedOutUserName();
			...
			if(backgammonUser != null){
				...
				userPermissionsUpdatedEvent.setUuid(loggedOutOpenByLeftBeforeGameStartedEvent.getUuid());
